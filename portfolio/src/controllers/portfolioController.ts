...
export class PortfolioController {
  ...
  getTradingStrategies = async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
  ...
  getAllTradingStrategies = async (req: Request, res: Response) => {
    try {
  ...
  createTradingStrategy = async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
  ...
  updateTradingStrategy = async (req: Request, res: Response) => {
    try {
  ...
  deleteTradingStrategy = async (req: Request, res: Response) => {
    try {
      const { strategyId } = req.params;
  ...
  assignStrategyToWatchlist = async (req: Request, res: Response) => {
    try {
      const { id, symbol } = req.params;
  ...
  assignStrategyToHolding = async (req: Request, res: Response) => {
    try {
      const { id, holdingId } = req.params;
      const { strategyId } = req.body;
